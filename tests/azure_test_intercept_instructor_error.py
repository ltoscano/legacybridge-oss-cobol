...
async def test_intercept_instructor_error():
    ...
    print(f"Model ID: {settings.ai_settings.model_id}/{settings.ai_settings.deployment_name}")
    print(f"api_version: {settings.ai_settings.api_version}")
...
Provide the dependency analysis."""
    ...
    try:
        ...
        response = await client.chat.completions.create(
            model=settings.ai_settings.deployment_name,
